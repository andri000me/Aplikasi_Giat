    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
            <h3 style="color:green;text-align:center;">INPUT DATA PENJUALAN BARANG</h3><br/>
             <form class="user" action="<?php blink('input/inputPenjualan')?>" method="post">

                <div class="form-group">
                <label>Customer :</label>
                <select class="form-control" id="" name="customer">
                  <?php if($dataCustomer == null) { ?>
                      <option value="">-</option>
                        <?php } else { ?>
                            <?php foreach($dataCustomer as $data){ ?>
                              <option value="<?php echo $data->kd_customer; ?>"><?php echo $data->nama_customer; ?></option>
                            <?php } ?>  
                        <?php } ?>
                  </select>
                </div>
                ...
                <select class="form-control" id="" name="barang">
                ...
                <label>Jumlah Barang :</label>
                  <input type="number" autocomplete="off" min="1" name="jumlah" class="form-control" id="" required>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" autocomplete="off" name="waktu" class="form-control" id="" required>
                </div>
                <div class="form-group">
                <label>Petugas :</label>
