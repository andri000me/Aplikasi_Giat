    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
            <h3 style="color:green;text-align:center;">INPUT DATA CUSTOMER</h3><br/>
             <form class="user" action="<?php blink('input/inputCustomer')?>" method="post">
                <div class="form-group">
                  <input type="text" name="nmCustomer" autocomplete="off" class="form-control form-control-user" id="" placeholder="Nama Customer" required>
                </div>
                <div class="form-group">
                  <input type="text" name="alamat" autocomplete="off" class="form-control form-control-user" id="" placeholder="Alamat" required>
                </div>
                <div class="form-group">
                  <input type="text" name="noTlp" autocomplete="off" class="form-control form-control-user" id="" placeholder="No.Telpon (62xxxxxxxx)" required>
                </div>
