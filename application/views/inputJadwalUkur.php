    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
            <h3 style="color:green;text-align:center;">INPUT JADWAL UKUR</h3><br/>
             <form class="user" action="<?php blink('input/inputJadwalUkur')?>" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="time" name="jam" autocomplete="off" class="form-control" id="jam" placeholder="00:00" required>
                </div>
                <div class="form-group">
