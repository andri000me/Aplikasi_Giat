    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
            <h1 class="h3 mb-3 text-gray-800">Input Jadwal Ukur</h1>
             <form class="user" action="<?php blink('input/inputJadwalUkur')?>" method="post">
                      ...
                      <option value="">-</option>
                        <?php } else { ?>
                            <?php foreach($dataCustomer as $data){ ?>
                              <option value="<?php echo $data->kd_customer; ?>"><?php echo $data->nama; ?></option>
                            <?php } ?>  
                        <?php } ?>
                  </select>
                </div>
                ...
                <label>Nama Barang :</label>
                  <input type="text" name="tgl" class="form-control" id="" placeholder="YYYY/MM/DD" required>
                </div>
                <div class="form-group">
                  <label>Jam Ukur :</label>
                  <input type="text" name="jam" class="form-control" id="" placeholder="12:00" required>
                </div>
                <div class="form-group">
