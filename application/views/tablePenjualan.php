    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h3 style="color:green;text-align:center;">LAPORAN PENJUALAN BARANG</h3>
         
        <?php foreach($dataPenjualan as $data){?>
          <!-- DataTales Example -->
          <div class="card shadow mb-4">
          <div class="card-header py-3"><a href="<?php echo site_url('Laporan/cetakLP/'.$data->customerkd_customer) ?>" class="btn btn-outline-info">Unduh Pdf</a>
