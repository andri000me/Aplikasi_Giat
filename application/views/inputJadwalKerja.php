...
<head>
  ...
  <title>Input Jadwal Kerja</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
            <h3 style="color:green;text-align:center;">INPUT JADWAL KERJA KARYAWAN</h3><br/>

            <form class="user" method="post" action="<?php blink('input/inputJadwalKerja')?>" >
            ...
            <button type="button" class="btn btn-danger" id="btn-reset-form">Reset Form</button><br><br>
                  ...
                  <input type="text" autocomplete="off" name="kode[]" value="KJ" class="form-control" required>
                  </div> -->
                  <div class="form-group">
                  ...
                  <input type="date" autocomplete="off" name="tgl[]" class="form-control" required>
                  </div>
                  <div class="form-group">
                ...
                <hr>
                <input type="submit" class="btn btn-primary btn-user btn-block" value="Simpan Jadwal Kerja">
              </form>
              ...
              $(document).ready(function(){ // Ketika halaman sudah diload dan siap
                $("#btn-tambah-form").click(function(){ // Ketika tombol Tambah Data Form di klik
                  ...
                  $("#insert-form").append("<b>Data ke " + nextform + " </b> <br/>" +
