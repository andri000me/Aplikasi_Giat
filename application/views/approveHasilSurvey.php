...
<head>
  ...
  <title>Approve Hasil Survey</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h3 style="color:green;text-align:center;">APPROVE HASIL SURVEY</h3>
         
        <?php foreach($dataSurvey as $data){?>
          <!-- DataTales Example -->
          <div class="card shadow mb-4">
          <div class="card-header py-3">
             <a href="#modalform<?php echo $data->ukurkd_jadwal_ukur ?>" data-toggle="modal" class="btn btn-outline-warning">Approve</a>
      ...
      <?php foreach($dataSurvey as $data){ ?> 
		<!-- modal -->
				<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" id="modalform<?php echo $data->ukurkd_jadwal_ukur ?>" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form method="POST" action="<?php blink('input/editApproveHasilSurvey');?>" enctype="multipart/form-data">
							            <div class="form-group">
                                            <label>Kode Jadwal Ukur</label>
                                            <input required class="form-control required text-capitalize" value="<?php echo $data->ukurkd_jadwal_ukur ?>" readonly data-placement="top" data-trigger="manual" type="text" name="kd_survey">
